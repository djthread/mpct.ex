...
var _user$project$Types$Model = F3(
	function (a, b, c) {
		return {config: a, state: b, playing: c};
	});
...
var _user$project$Api$url = function (config) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'http://',
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				':',
				_elm_lang$core$Basics$toString(config.http_port))));
};
...
var _user$project$State$update = F2(
	function (action, model) {
		...
		switch (_p0.ctor) {
			...
			case 'CallSucceed':
				var model = A3(_user$project$Api$update, _p0._0, _p0._1, model);
				return A2(
					_elm_lang$core$Debug$log,
					'succes.',
...
var _user$project$State$init = function (config) {
	return {
		ctor: '_Tuple2',
		_0: {config: config, state: '', playing: false},
...
var _user$project$App$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$State$init(_user$project$App$config),
